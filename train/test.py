...
for index, name in enumerate(folder):
    ...
    for file in files:
        if color_setting == 1:
            ...
            img = load_img(file, color_mode="rgb",
                           target_size=(image_width, image_height))
...
_, X_test_data, _, Y_test_data = train_test_split(X_test, Y_test, test_size=0.1, random_state=42)
...
sns.heatmap(cm, annot=True, cmap="Blues", fmt="d",
            xticklabels=folder, yticklabels=folder)
